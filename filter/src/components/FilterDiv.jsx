    ...
    if (id === "selectAll") {
      if (checked) {
        setSelectedIndustries(
          filteredIndustries.map((industry) => industry.id)
        );
      } else {
        setSelectedIndustries([]);
      }
  ...
  return (
    <div className="container" style={{ height: containerHeight }}>
      <div className="headerDiv">
        <span class="MuiBadge-root filter-icon-badge css-1rzb3uu">
          <svg
          ...
          >
            <g clip-path="url(#fi-rs-building_svg__a)">
              <path
                fill="#3E545C"
          ...
          <span class="MuiBadge-badge MuiBadge-dot MuiBadge-anchorOriginTopRight MuiBadge-anchorOriginTopRightRectangular MuiBadge-overlapRectangular MuiBadge-colorSuccess css-1veqbpl"></span>
          Industry
        </span>
